...
export function AdminAnalytics() {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-8">
        <h1 className="text-3xl font-headline-md font-bold text-on-surface"><BilingualText text="Global Analytics" /></h1>
        <p className="text-on-surface-variant"><BilingualText text="City-wide overview of grievance reports and departmental performance." /></p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          <h2 className="text-xl font-bold mb-6 text-on-surface"><BilingualText text="Most Common Issues" /></h2>
        ...
        <motion.div 
          ...
          className="glass-panel p-8 rounded-[2.5rem]"
        >
          <h2 className="text-xl font-bold mb-6 text-on-surface"><BilingualText text="Department Workload" /></h2>
          <div className="h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
