    ...
    switch(status) {
      case 'Resolved': return (
        <div className="bg-secondary/10 border border-secondary/20 p-4 rounded-2xl flex items-center gap-3 text-secondary mb-8">
          <CheckCircle size={24} />
          <div>
            <h4 className="font-bold">Issue Resolved</h4>
            <p className="text-sm opacity-80">The responsible department has fixed this issue.</p>
          </div>
        </div>
      );
      case 'In-Progress': return (
        <div className="bg-warning/10 border border-warning/20 p-4 rounded-2xl flex items-center gap-3 text-warning mb-8">
          ...
          <div>
            ...
            <p className="text-sm opacity-80">A team has been dispatched and is currently working on this.</p>
          </div>
        </div>
      );
      default: return (
        <div className="bg-surface-container-high border border-outline-variant/30 p-4 rounded-2xl flex items-center gap-3 text-on-surface-variant mb-8">
          <Clock size={24} />
          <div>
            <h4 className="font-bold">Pending Assignment</h4>
            <p className="text-sm opacity-80">This issue has been logged and is awaiting department review.</p>
          </div>
        </div>
      );
    }
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          <div className="glass-panel p-8 rounded-[2.5rem]">
            <h1 className="text-2xl font-headline-md font-bold mb-4 text-on-surface">Issue Details</h1>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-on-surface-variant uppercase">Department</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-on-surface-variant uppercase">Severity</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-on-surface-variant uppercase">AI Visual Tag</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-on-surface-variant uppercase">Date Reported</p>
          ...
          {(grievance.status === 'Resolved' || !grievance.status) && (
            <div className="glass-panel p-8 rounded-[2.5rem] border border-secondary/20 relative overflow-hidden">
              ...
              <h2 className="text-xl font-bold mb-4 flex items-center gap-2 text-secondary">
                <Camera size={20} /> Resolution Proof
              </h2>
              <div className="aspect-video bg-surface-container rounded-2xl border border-outline-variant/30 flex items-center justify-center relative overflow-hidden">
                ...
                <p className="text-on-surface-variant font-bold z-10 flex items-center gap-2">
                  <CheckCircle size={18} /> Verified by Department
                </p>
              </div>
            </div>
          )}
        ...
        <div className="space-y-6">
          <div className="glass-panel p-6 rounded-[2rem]">
            <h3 className="font-bold mb-4 flex items-center gap-2"><MapPin size={18} className="text-primary"/> Location Details</h3>
